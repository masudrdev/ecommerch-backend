...
-- CreateEnum
CREATE TYPE "FinanceTransactionType" AS ENUM ('ORDER_PAYMENT', 'COMMISSION', 'VENDOR_EARNING', 'PAYOUT', 'REFUND', 'ADJUSTMENT');

-- CreateEnum
CREATE TYPE "FinanceTransactionStatus" AS ENUM ('COMPLETED', 'PENDING', 'FAILED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "TicketStatus" AS ENUM ('OPEN', 'PENDING', 'IN_PROGRESS', 'WAITING_FOR_CUSTOMER', 'WAITING_FOR_STAFF', 'ESCALATED', 'RESOLVED', 'CLOSED', 'REJECTED');
